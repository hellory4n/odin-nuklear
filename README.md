...
Bindings generated by [odin-c-bindgen](https://github.com/karl-zylinski/odin-c-bindgen) and `build.bat`/`build.sh`.

Note: the build scripts require you to have `odin-c-bindgen` in your PATH.
...
Last Nuklear commit hash: [a1856105f45fa0da552872cca17d5c9b5950d582](https://github.com/Immediate-Mode-UI/Nuklear/commit/a1856105f45fa0da552872cca17d5c9b5950d582)
